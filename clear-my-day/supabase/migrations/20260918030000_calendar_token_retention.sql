-- Subscription URLs are bearer credentials. Remove subscriptions that have not
-- been requested for 180 days, together with any generated ICS cache entry.
...
begin
  ...
  delete from public.ics_output_cache
...
comment on function public.cleanup_expired_cache_rows() is
  'Deletes expired caches and calendar subscriptions inactive for 180 days.';
